...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002267822942 -1002348118344').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
...
DATABASE_NAME = environ.get('DATABASE_NAME', "mmtg")
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002278395603')) # 
